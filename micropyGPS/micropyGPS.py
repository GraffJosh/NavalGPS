...
class MicropyGPS(object):
    ...
    def compass_direction(self):
        ...
        if self.course >= 360 - declination:
            offset_course = 360 - self.course
        else:
            offset_course = self.course + declination
    ...
    def heading_string(self):
        ...
        return str(offset_course)

    def latitude_string(self, str_format=""):
        """
        Create a readable string of the current latitude data
        :return: string
        """
        if not str_format:
            str_format = self.coord_format
        else:
            self.coord_format = str_format
        if str_format == "dd":
            ...
            if self._latitude[2] == "S":
                ...
                sign_string = ""
            lat_string = sign_string + str(formatted_latitude[0])  # + ". " + str(self._latitude[2])
        elif str_format == "dms":
            formatted_latitude = self.latitude
            lat_string = (
    ...
    def longitude_string(self, str_format=""):
        """
        ...
        if str_format == "dd":
            ...
            if self._longitude[2] == "W":
                ...
                sign_string = ""
            lon_string = sign_string + str(
                formatted_longitude[0]
